...
const routes = [
    { // Доступен без авторизации (главная)
        ...
        meta:{
            // Дополнительные метаданные для маршрута. Этот маршрут использует layout 'main'
            layout: 'main',
        },
    },
    { // Доступен с авторизацией (страница добавления нового рецепта)
        ...
        meta:{
            // Дополнительные метаданные для маршрута. Этот маршрут использует layout 'common-form'
            layout: 'common-form',
            auth: true,
        },
    },
