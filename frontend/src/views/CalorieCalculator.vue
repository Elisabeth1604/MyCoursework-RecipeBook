<template>
    <div class="container">
        <div v-if="!showResults">
            ...
            <p class="subtitle">
                Рассчитайте сколько калорий, белков, жиров и углеводов вам нужно потреблять
                ежедневно для поддержания веса, похудения или набора массы.
            </p>
            ...
            <section>
                ...
                <div class="goal-buttons">
                    <AppButton v-for="g in goals" :key="g.value"
            ...
            <section>
                ...
                <div class="formula-buttons">
                    <AppButton v-for="f in formulas" :key="f.value"
            ...
            <AppButton
                @click="onCalculate">Рассчитать</AppButton>
