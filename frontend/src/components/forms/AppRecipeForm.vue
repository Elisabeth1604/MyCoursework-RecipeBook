    ...
    <form @submit.prevent="submitRecipe">
        ...
        <div class="form-group">
            ...
            >
                ...
                <AppButton
                    ...
                    type="button"
                >Удалить <span class="ingredient-text">ингредиент</span></AppButton>
            </div>
        ...
        <div class="form-group">
            ...
            <select v-model="category"
                    ...
                    @error="catDisplayError"
                    @blur="catBlur"
                    :class="{ invalid: catDisplayError }">
        ...
        <div class="inform-case">
            ...
            <p class="inform">
                Рекомендуем разбивать рецепт минимум на 5 шагов. Используй горизонтальные фото!
            </p>
        </div>

        <div class="form-group">
            <div v-for="(step, index) in localRecipe.steps"
                 :key="index"
                 class="step">
                ...
                >Удалить шаг</AppButton>

                <div v-if="stepPreviews[index]"
                     class="step-preview-container">
                    <img
...
watch(
    ...
    (newVal) => {
        if (!newVal) return;
        // заполнение валидируемых полей текущими значениями newVal
...
.ingredient {
    display: grid;
    grid-template-columns: 30% 15% 26% auto;
    align-items: center;
    margin-top: 10px;
    margin-bottom: 10px;
    padding: 10px;
...
@media (max-width: 595px) {
    ...
    /* Чтобы на экранах шириной менее 584px исчезло слово "ингредиент" в кнопке удалить ингредиент */
...
@media (max-width: 522px) {
    ...
    .ingredient {
        display: grid;
        grid-template-columns: 33% 18% 28% auto;
    }
}
