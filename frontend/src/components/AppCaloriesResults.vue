<template>
    <div class="results">
        ...
        <table>
            <tbody>
                <tr>
                    <td>Ваш базовый метаболизм (минимальная норма)</td>
                    <td>{{ calorieBase }}</td>
                </tr>
                <tr>
                    <td>Норма калорий для поддержания веса</td>
                    <td>{{ calorieMaintain }}</td>
                </tr>
                <tr>
                    <td>Дефицит калорий 20% (для похудения)</td>
                    <td>{{ calorieDeficit20 }}</td>
                </tr>
                <tr>
                    <td>Дефицит калорий 15% (для похудения)</td>
                    <td>{{ calorieDeficit15 }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            <tbody>
                ...
                <tr v-if="female">
                    <td>В тяжёлые дни (ПМС, КД и т.д.)</td>
                    <td>{{ Math.round(calorieMaintain * 0.9) }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ proteinRange[0] }}</td>
                    <td>{{ proteinRange[1] }}</td>
                </tr>
                <tr>
