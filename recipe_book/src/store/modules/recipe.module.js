export default {
      ...
      recipes:[ 
        {
            ...
            prepTime: 40,
            ingredients: [
            { name: 'Спагетти', amount: 200, unit:'гр' },
            { name: 'Яйца', amount: 2, unit:'шт.' },
            { name: 'Бекон', amount: 100, unit:'гр' },
            { name: 'Сыр пармезан', amount: 50, unit:'гр' },
            { name: 'Сливки', amount: 50, unit:'мл' }
            ],
            steps: [
        ...
        },
        {
            ...
            prepTime: 60,
            ingredients: [
                { name: 'Курица', amount: 200, unit:'гр' },
                { name: 'Карри', amount: 1, unit:'щеп.' },
          ...
          },
          {
            ...
            prepTime: 35,
            ingredients: [
                { name: 'Листья салата', amount: 400, unit:'гр' },
                { name: 'Курица', amount: 280, unit:'гр' },
                { name: 'Сыр пармезан', amount: 80, unit:'гр' },
                { name: 'Гренки', amount: 200, unit:'гр' },
                { name: 'Соус Цезарь', amount: 300, unit:'гр' },
          ...
          },
          {
            ...
            ingredients: [
                ...
                { name: 'Мясо', amount: 600, unit:'гр' },
                { name: 'Картофель', amount: 3, unit:'шт.' },
                { name: 'Морковь', amount: 1, unit:'шт.' },
                { name: 'Капуста', amount: 200, unit:'гр' },
                { name: 'Лук', amount: 1, unit:'шт.' },
                { name: 'Томатная паста', amount: 2, unit:'стол.л.' }
                ],
            steps: [
          ...
          },
          {
            ...
            prepTime: 60,
            ingredients: [
                { name: 'Рис', amount: 300, unit: 'гр' },
                { name: 'Мясо(баранина)', amount: 300, unit: 'гр' },
                { name: 'Морковь', amount: 1, unit: 'шт.' },
                { name: 'Чеснок', amount: 1, unit: 'зубч.' },
                { name: 'Лук', amount: 1, unit: 'шт.' },
                { name: 'Зира', amount: 1, unit: 'чайн.л.' },
          ...
          },
          {
            ...
            prepTime: 60,
            ingredients: [
                { name: 'Пшеничная мука', amount: 195, unit:'гр' },
                { name: 'Сухие дрожжи', amount: 1, unit:'шт.' },
                { name: 'Сахар', amount: 1, unit:'стол.л.' },
                { name: 'Соль', amount: 1, unit:'щеп.' },
                { name: 'Томатная паста', amount: 3, unit:'стол.л.' },
                { name: 'Моцарелла', amount: 200, unit:'гр' },
                { name: 'Помидоры черри', amount: 8, unit:'шт.' },
                { name: 'Оливковое масло', amount: 4, unit:'стол.л.' }
                ],
            steps: [
    ...
    getters: {
        ...
        getUserRecipes: (state) => (userId) => {
          return state.recipes.filter(recipe => recipe.userId === userId);
        },
    },
    mutations: {
